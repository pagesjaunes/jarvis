...
use Jarvis\Console\Helper\DescriptorHelper;
...
class ContainerDebugCommand extends Command
{
    ...
    {
        return $this->container->hasParameter('debug.container.dump');
    }
    ...
    protected function configure()
    {
        $this
            ...
            ->setDescription('Displays current services for the application')
            ->setHelp(<<<EOF
